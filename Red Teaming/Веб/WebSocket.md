...
- Манипулирование хэндшейком WebSocket:
	- Слепое доверие к HTTP-заголовкам (например, изменить исходящий IP-адрес с помощью X-Forwarded-For). Атакующий может управлять заголовками, поэтому решения об авторизации, ограничениях доступа или тарификации на основе HTTP-заголовков могут оказаться уязвимыми
